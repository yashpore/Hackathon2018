...
public class ErrorAuditReport {
	...
	ArrayList<ErrorAuditDetails> errors;
	...
	public ArrayList<ErrorAuditDetails> getErrors() {
		return errors;
	}

	public void setErrors(ArrayList<ErrorAuditDetails> errors) {
		this.errors = errors;
	}
}